...
public class EmployeeService {
	...
	public void findByFirstName(String empFirstName) {
		...
		try {
			...
			logger.info("List of employees who are having first name as: " + empFirstName);
		} catch (EmployeeNotFoundException e) {
			logger.error("Not able to find with first name: " + empFirstName);
		}
	...
	public void findByBirthday(LocalDate empDateOfBirth) {
		...
		employeeList.forEach(e -> System.out.println("FirstName :"+e.getEmpFirstName() + " and Email :" + e.getEmpEmail()));
	}
